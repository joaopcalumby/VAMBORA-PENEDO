    ...
    <main className="flex flex-col justify-center items-center min-h-screen bg-white px-4 py-2">
      ...
      <section className="mx-auto flex w-full max-w-md flex-col gap-6 rounded-2xl bg-white p-8 border-1 border-[#E5E5E5] shadow-xl">
        <header className="space-y-1 text-center">
          <h1 className="text-xl font-medium text-zinc-900">Faça login na sua conta</h1>
        ...
        <form className="space-y-4">
          ...
          <div className="flex justify-end items-center">
            <Link href="/register" className="text-sm font-medium text-[#20FC8F] hover:text-zinc-900">
              Esqueceu a senha ?
            </Link>
          </div>
          <div className="flex flex-col justify-center items-center gap-5">
            <button className="w-full rounded-lg bg-[#20FC8F] py-2 font-semibold text-black transition hover:bg-[#304643]">
              Login
            </button>
            <Link className="flex text-black gap-2 items-center justify-center" href="/register">Criar conta <MoveRight /></Link>
            </div>
        </form>
      </section>
    </main>
